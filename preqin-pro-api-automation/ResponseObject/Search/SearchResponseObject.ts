...
export class Datum {
    ...
    @JsonProperty("fundManagerDetails.pE.overallInvestmentCriteria.strategies", [String])
    ...
    @JsonProperty("fundManagerDetails.snapshots.PE.totalCapitalRaised.usdMn", Number)
    ...
    @JsonProperty("fundManagerDetails.snapshots.PE.estimatedDryPowder.usdMn", Number)
    ...
    @JsonProperty("fundManagerDetails.snapshots.RE.totalCapitalRaised.usdMn", Number)
    ...
    @JsonProperty("fundManagerDetails.snapshots.RE.estimatedDryPowder.usdMn", Number)
    ...
    @JsonProperty("fundManagerDetails.pD.overallInvestmentCriteria.strategies", String)
    ...
    @JsonProperty("fundManagerDetails.snapshots.PD.totalCapitalRaised.usdMn", Number)
    ...
    @JsonProperty("fundManagerDetails.snapshots.PD.estimatedDryPowder.usdMn", Number)
    ...
    @JsonProperty("fundManagerDetails.nR.preferences.strategies", [String])
    ...
    @JsonProperty("fundManagerDetails.snapshots.NR.totalCapitalRaised.usdMn", Number)
    ...
    @JsonProperty("fundManagerDetails.snapshots.NR.estimatedDryPowder.usdMn", Number)
    ...
    @JsonProperty("fundManagerDetails.iNF.primaryStrategies", [Any])
    ...
    @JsonProperty("fundManagerDetails.snapshots.INF.totalCapitalRaised.usdMn", Any)
    ...
    @JsonProperty("fundManagerDetails.snapshots.INF.estimatedDryPowder.usdMn", Any)
    ...
    @JsonProperty("fundManagerDetails.hF.category", [String])
    ...
    @JsonProperty("fundManagerDetails.funds", [FundManagerDetailsFund])
    ...
    @JsonProperty("fundManagerDetails.hF.coreStrategies", [String])
    ...
    @JsonProperty("fundManagerDetails.snapshots.HF.aUM.localMn", Number)
    ...
    @JsonProperty("addressDetails.fax", String)
    ...
    @JsonProperty("addressDetails.state", String)
    ...
    @JsonProperty("addressDetails.postcode", String)
    ...
    @JsonProperty("addressDetails.line", String)
    ...
    @JsonProperty("addressDetails.email", String)
    ...
    @JsonProperty("addressDetails.region", String)
    ...
    @JsonProperty("addressDetails.website", String)
    ...
    @JsonProperty("addressDetails.telephone", String)
...
@JsonObject("SearchResponseRootObject")
export class SearchResponseRootObject {
