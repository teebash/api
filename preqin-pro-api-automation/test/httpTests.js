...
describe('Generic type Tests', () => {
    ...
    // });
    it('Search endpoint, complex post request', () => __awaiter(this, void 0, void 0, function* () {
        let payload = yield searchRequestObject.CreateSearchRequestObject(1, 2, "name", "ascending", "FundManager", [{ id: "officeType", type: "LIST", filterOperation: "null", filterBy: ["head_office"] }]);
        let responseObject = yield apiClient.Post('search-api/search', payload, 200, SearchResponseObject_1.SearchResponseRootObject);
        chai_1.assert.equal(responseObject.Data[0].Name, ".406 Ventures");
    }));
    ...
    xit('Example, Nested object', () => __awaiter(this, void 0, void 0, function* () {
